...
- (void)request:(SKRequest *)request didFailWithError:(NSError *)error {
	...
	InAppStore::get_singleton()->emit_signal("on_request_complete", ret);
}
...
- (void)paymentQueueRestoreCompletedTransactionsFinished:(SKPaymentQueue *)queue {
   ...
   InAppStore::get_singleton()->emit_signal("on_transaction_complete", ret);
}
...
void InAppStore::_bind_methods() {
	...
	ADD_SIGNAL(MethodInfo("on_request_complete", PropertyInfo(Variant::DICTIONARY, "result")));
	ADD_SIGNAL(MethodInfo("on_transaction_complete", PropertyInfo(Variant::DICTIONARY, "result")));
	ADD_SIGNAL(MethodInfo("on_purchase_complete", PropertyInfo(Variant::DICTIONARY, "result")));
